...
include "setting.php";
    ...
    $sql_signup = mysqli_query($conn, "INSERT INTO `member` (id, name, pwd, s_num, interest1, interest2, interest3, profile, list_num, noti_ap, noti_recvap, noti_vol) VALUES('$signup_email', '$signup_name', '$signup_pwd', '$signup_num', '$signup_inter1', '$signup_inter2', '$signup_inter3', '$signup_profile', 0, 1, 1, 1)");
    if(!$sql_signup){ echo "
    <script>
    alert('회원가입에 실패했습니다');
    location.href='signup.php'
